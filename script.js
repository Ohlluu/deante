...
console.log('%c🎙️ Grits & Eggs Podcast', 'font-size: 24px; font-weight: bold; color: #f7eb73; background: #000; padding: 10px;');
console.log('%cWebsite built with ❤️', 'font-size: 14px; color: #666;');
